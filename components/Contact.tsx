  ...
  const submitBooking = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.message?.includes('Missing or insufficient permissions')) {
         setBookingError("Permission denied. Please update your Firestore Security Rules in the Firebase Console to allow writes to the 'bookings' collection.");
      } else {
    ...
    <section id="contact" className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <span className="text-orange-500 font-medium tracking-widest uppercase text-sm mb-3 block">Get in Touch</span>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {!user ? (
                ...
                >
                  <div className="mb-8">
                    <h3 className="text-2xl font-bold text-white mb-2">{authMode === 'login' ? 'Sign In to Book' : 'Create an Account'}</h3>
                    <p className="text-gray-400 text-sm">Please authenticate to submit your project request.</p>
                  </div>
                  ...
                  <form onSubmit={handleEmailAuth} className="space-y-4">
                    ...
                    >
                      {isSubmitting ? 'Authenticating...' : (authMode === 'login' ? 'Sign In' : 'Sign Up')}
                    </button>
                  </form>
                  ...
                  <div className="relative py-4">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 bg-[#0B0B0B] text-gray-500">Or continue with</span>
                    </div>
                  </div>
                ...
                >
                  <div className="flex justify-between items-center mb-8 pb-4 border-b border-white/10">
                    <div>
                      <h3 className="text-xl font-bold text-white">Project Booking</h3>
                      <p className="text-sm text-orange-400">Signed in as {user.email}</p>
                    </div>
                    <button 
                  ...
                  {bookingSuccess ? (
                    <div className="text-center py-8">
                      ...
                      <h4 className="text-2xl font-bold text-white mb-2">Booking Received!</h4>
                      <p className="text-gray-400 mb-6">Thank you for reaching out. I will get back to you shortly.</p>
                      <button 
