...
const services = [
  {
    ...
    title: 'UI/UX Design',
    description: 'Crafting premium, intuitive, and modern user interfaces with a focus on immersive experiences and glassmorphism aesthetics.',
  },
  {
    icon: <Code2 className="w-8 h-8 text-orange-400" />,
    title: 'Frontend Development',
    description: 'Building high-performance, pixel-perfect web applications using React, Next.js, and modern CSS frameworks.',
  },
  {
    icon: <Smartphone className="w-8 h-8 text-orange-400" />,
    title: 'Responsive Layouts',
    description: 'Ensuring your website looks flawless on all devices, from ultra-wide desktop monitors to mobile screens.',
  },
  {
    icon: <Sparkles className="w-8 h-8 text-orange-400" />,
    title: 'Interactive Animation',
    description: 'Adding cinematic motion, scroll effects, and micro-interactions to make the digital experience feel alive and premium.',
  },
];
  ...
  return (
    <section id="services" className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <span className="text-orange-500 font-medium tracking-widest uppercase text-sm mb-3 block">What I Do</span>
