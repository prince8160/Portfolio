  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      if (err.code === "auth/popup-blocked") {
        setError("Popup blocked. Please allow popups or use a new tab.");
      } else if (
        err.message &&
              ...
              {mode === "login" ? (
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <div
                          className={`w-3.5 h-3.5 rounded-sm border flex items-center justify-center transition-colors ${rememberMe ? "bg-blue-600 border-blue-600" : "border-white/20 group-hover:border-white/40"}`}
                        >
                          {rememberMe && (
                  ...
                  <div className="my-5 relative flex items-center justify-center z-10">
                    ...
                    <span className="relative bg-[#0A0A0B] px-3 text-[10px] text-gray-500 uppercase tracking-wider">
                      Or
                    </span>
                  </div>
                  ...
                  <div className="hidden md:flex md:w-[45%] relative bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-8 flex-col justify-between overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-white/90 text-sm leading-relaxed font-light max-w-[260px]">
                        Create an account to unlock premium features and start
                        building amazing experiences today.
                      </p>
                    </div>
                  ...
                  <div className="w-full md:w-[55%] p-7 sm:p-10 relative bg-slate-50/50">
                    ...
                    <form onSubmit={handleAuth} className="space-y-3.5">
                      ...
                      <label className="flex items-start gap-2.5 mt-4 cursor-pointer group">
                        <div
                          className={`mt-0.5 w-4 h-4 rounded-md border flex items-center justify-center transition-all shrink-0 ${agreeTerms ? "bg-gradient-to-r from-purple-500 to-pink-500 border-transparent" : "border-gray-300 bg-white group-hover:border-pink-400"}`}
                        >
                          {agreeTerms && (
                        ...
                        <span className="text-xs text-gray-600 select-none leading-relaxed">
                          ...
                          <a
                            href="#"
                            className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500 hover:opacity-80 font-semibold border-b border-pink-200 pb-0.5"
                          >
                            Terms of Service
                          </a>{" "}
                          &{" "}
                    ...
                    <div className="my-6 relative flex items-center justify-center">
                      ...
                      <span className="relative bg-slate-50 px-3 text-[10px] text-gray-400 uppercase tracking-widest font-bold">
                        Or sign up with
                      </span>
                    </div>
