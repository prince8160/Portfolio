          ...
          >
            ...
            <div className="glass-panel p-8 rounded-3xl relative z-10 border border-white/10">
              <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 tracking-tight">
                Crafting Digital <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Experiences</span>
              </h2>
              <p className="text-gray-400 text-lg leading-relaxed mb-6 font-light">
                I am a passionate web developer with a keen eye for aesthetics and a strong technical foundation. I specialize in building highly interactive, responsive, and performant web applications that leave a lasting impression.
              </p>
              <p className="text-gray-400 text-lg leading-relaxed mb-8 font-light">
                My approach combines clean code architecture with premium design principles, ensuring every project not only functions flawlessly but looks extraordinary.
              </p>
              
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div>
                  <h4 className="text-4xl font-display font-bold text-white mb-2">1+</h4>
                  <p className="text-sm tracking-wide uppercase text-orange-500 font-medium">Years Experience</p>
                </div>
                <div>
                  <h4 className="text-4xl font-display font-bold text-white mb-2">50+</h4>
                  <p className="text-sm tracking-wide uppercase text-orange-500 font-medium">Projects Delivered</p>
                </div>
              </div>
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-2">
                  Download Resume <Download size={18} className="group-hover:-translate-y-1 group-hover:text-orange-400 transition-all duration-300" />
                </span>
              </a>
            </div>
          </motion.div>
          ...
          >
             ...
             <div className="absolute bottom-8 left-8 right-8 z-30">
               <div className="glass-panel p-6 rounded-2xl">
                 ...
                 <p className="text-sm text-gray-300">Transforming complex problems into elegant, intuitive, and modern web solutions.</p>
               </div>
             </div>
          </motion.div>
